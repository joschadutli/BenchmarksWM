...
portrat16 <- portrat16 %>% rename(subj = subject, condition = acronym,
                                  pace = Pace, acc = pc)
save(portrat16, file = "./pkg/data/portrat16.rda")
...
save(thalmann19a, file = "./pkg/data/thalmann19a.rda")
...
save(thalmann19b, file = "./pkg/data/thalmann19b.rda")
...
save(thalmann19c, file = "./pkg/data/thalmann19c.rda")
...
save(thalmann19d, file = "./pkg/data/thalmann19d.rda")
...
save(quinlan17, file = "./pkg/data/quinlan17.rda")
...
save(page06, file = "./pkg/data/page06.rda")
