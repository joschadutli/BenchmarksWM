...
## note: op: 12; na: 12; count: 15; sym: 12; reading: 12; rot: 12
...
kane04trial <- kane04
data("kane04trial")
names(kane04trial)[15:27] <- c("ets.inference", "paper.folding", "afq.analogies", 
                               "dat.space.relations", "remote.associates", 
                               "afq.rotated.blocks",
                               "ets.nonsense.syllogisms", "ets.surface.development", 
                               "afq.reading.comprehension", "ets.form.board", 
                               "wasi.matrices",
                               "raven.matrices", "beta3.matrices")
kane04t <- kane04trial
save(kane04t, file = "./pkg/data/kane04t.rda")
